...
// initialOwner:        "11", "Lifest"yle", "Kyle"
...
*/
    ...
    function getProductDetails (string _code) public view returns (string ,string ,string ,string ,string,string){
        
        return(codeArr[_code].brand,codeArr[_code].model,codeArr[_code].description,codeArr[_code].manufactuerName,codeArr[_code].manufactuerLocation,codeArr[_code].manufactuerTimestamp);
    }
   ...
   // function createCustomer(string _hashedEmail, string _name, string _phone) public payable returns (uint) {
  ...
  //  }
    ...
    //     retailerArr[_hashedEmail] = newRetailer;//Key value (mapping)
    //     return 1;
    // }
